...
export function KeyboardShortcuts(): React.ReactElement {
  return (
    <Box flexDirection="column">
      ...
      <Text>  <Text color="cyan" bold>PgUp/Dn</Text>   scroll focused pane by page</Text>
      <Text>  <Text color="cyan" bold>Ctrl-P/N</Text>  scroll focused pane by one message (fine control)</Text>
      <Text>  <Text color="cyan" bold>Home/End</Text>  scroll to top / bottom of history (focused pane)</Text>
